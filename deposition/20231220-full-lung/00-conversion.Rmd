...
```{r}
date = "20231220"
parent <- paste0("deposition/",date,"-full-lung/")
file_name <- paste0(date,"_full_lung_run_CF_analysis.xlsx")
...
```{r}
lobe_deposition_mass %>% write_csv(make_path(paste0("data/summary-full-lung-", date, ".csv")))
```
