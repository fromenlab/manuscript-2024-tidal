...
```{r}
parent <- "deposition/20240123-full-lung/data/"
data_folder = "240123-3b5-d4/data/"
...
peak_indices <- c(5692, 5887, 6205, 6394, 6711, 6901, 7216, 7405, 7724, 7914, 8231, 8420, 8739, 8930, 9244, 9433, 9752, 9942, 10257, 10448, 10766, 10954, 11271)
