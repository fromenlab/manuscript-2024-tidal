...
centerlineReader.InputFileName = r'ioc/ioc-internal-cl-sp-merged.vtp'
...
clipSurfaceWriter.OutputFileName = r'ioc/ioc-internal-clipped-merged.vtp'
clipSurfaceWriter.Execute()

# Write clipped branches centerlines
clipSurfaceWriter.OutputFileName = r'ioc/ioc-internal-clipped-merged-cl.vtp'
...
clipSurfaceWriter = vmtkscripts.vmtkSurfaceWriter()
clipSurfaceWriter.Surface = branchClipper.Surface
clipSurfaceWriter.OutputFileName = r'ioc/ioc-internal-clipped-merged.stl'
clipSurfaceWriter.Execute()
